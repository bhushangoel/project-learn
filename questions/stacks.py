...
def largestRectangle(height):
    ...
    print("height : ", height, len(height))
    while i <= len(height):
        print("increasing : ", i, increasing)
...
#
#
# def matches(top_symbol, current_symbol):
#     symbol_dict = {
#         "(": ")",
#         "{": "}",
#         "[": "]"
#     }
#     if symbol_dict[top_symbol] == current_symbol:
#         return True
#     else:
#         return False
#
...
#                 balanced = 0
#             else:
#                 top_symbol = our_stack.pop()
#                 if matches(top_symbol, symbol):
#                     balanced = 1
#                 else:
#                     balanced = 0
#                     break
#
#     print("after : ", our_stack.size())
#     if our_stack.size() > 0:
#         return 0
#     else:
#         return balanced
...
#     }
#     for i in input_list:
#         print("stack - ", stk, 'postfix - ', postfix)
...
#                 postfix.append(a)
#             stk.pop()
#         elif str(i) in operator_list:
#             p = priority[i]
#
#             for j in range(0, len(stk)):
#                 if stk[-1] in operator_list and priority[stk[-1]] <= p:
#                     a = stk.pop()
#                     postfix.append(a)
#                 else:
#                     stk.append(i)
...
#         our_stack.push(arr[1])
#     else:
#         if arr[0] == 2:
#             our_stack.pop()
#             return our_stack.stk
#         else:
#             top = our_stack.size()
#             i = 0
#             max = 0
#             while i < top:
#                 if our_stack.stk[i] > max:
#                     max = our_stack.stk[i]
#                 i += 1
#             return max
#
